...
public class Delete extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 20, 190, 63));
        ...
        Sales.setText("Sales");
        jPanel1.add(Sales, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 260, 170, 48));
        ...
        jPanel1.add(Back, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 680, 90, 40));

        LogOut.setText("LogOut");
        jPanel1.add(LogOut, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 750, 90, 40));
        ...
        getContentPane().add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 130, 330, 80));
        ...
        jPanel3.add(DELETE, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 190, 110, 33));

        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 250, 400, 250));
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 520, 1140, 270));
        ...
        getContentPane().add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 100, 1600, 710));
    ...
    private void DELETEActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DELETEActionPerformed
        ...
        String query = "DELETE FROM  bookshop2  WHERE Book_ID = " +BOOKID.getText();
    ...
    private void executeSQLQuery(String query, String deleted) {
